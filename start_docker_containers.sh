...
docker exec -u admin --workdir /workspaces/isaac_ros-dev $CONTAINER_NAME vslam_realsense.sh

# Attach to running container
echo "Attaching to running container"
docker exec -u admin --workdir /workspaces/isaac_ros-dev $CONTAINER_NAME foxglove.sh
